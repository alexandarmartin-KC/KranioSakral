...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s"><a href="/" class="navbar-brand d-flex align-items-center px-4 px-lg-5"><h1 class="m-0 text-primary">Kranio Sakral Terapi v/Dorthe Pia</h1></a><button type="button" class="navbar-toggler me-4" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><div class="collapse navbar-collapse" id="navbarCollapse"><div class="navbar-nav ms-auto p-4 p-lg-0"><a href="/" class="nav-item nav-link">Forside</a><a href="/kranio-sakral-terapi" class="nav-item nav-link">Kranio Sakral Terapi</a><a href="/priser-booking" class="nav-item nav-link">Priser & Booking</a><a href="/om-mig" class="nav-item nav-link active">Om mig</a></div></div></nav>
	<div class="container-fluid header bg-primary p-0 mb-5">
		<div class="row g-0 align-items-center">
			<div class="col-lg-6 col-12 p-5 wow fadeIn text-center text-lg-start" data-wow-delay="0.1s">
				...
				<a href="/priser-booking" class="btn btn-primary rounded-pill py-2 px-4 me-3 d-none d-lg-inline-block">Book tid</a>
		...
		<div class="container">
			<div class="therapy-full-card">
				...
				<div class="text-center mt-5">
					<a href="/priser-booking" class="btn btn-primary rounded-pill py-2 px-4">Book tid<i class="fa fa-arrow-right ms-3"></i></a>
				</div>
	...
	<div class="container-fluid bg-dark text-light border-top border-secondary" style="padding: 6px 0;"><div class="container text-center"><small>&copy; <?= date('Y') ?> Kranio Sakral Terapi v/Dorthe Pia · CVR: 37448710 · All rights reserved.</small></div></div>
