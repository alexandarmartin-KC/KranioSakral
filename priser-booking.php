...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s"><a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5"><h1 class="m-0 text-primary">Kranio Sakral Terapi v/Dorthe Pia</h1></a><button type="button" class="navbar-toggler me-4" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><div class="collapse navbar-collapse" id="navbarCollapse"><div class="navbar-nav ms-auto p-4 p-lg-0"><a href="index.php" class="nav-item nav-link">Forside</a><a href="kranio-sakral-terapi.php" class="nav-item nav-link">Kranio Sakral Terapi</a><a href="priser-booking.php" class="nav-item nav-link active">Priser & Booking</a><a href="om-mig.php" class="nav-item nav-link">Om mig</a></div><a href="tel:+4522901025" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Ring nu<i class="fa fa-arrow-right ms-3"></i></a></div></nav>
