    ...
    return [
        'index' => [
            ...
            'sections' => [
                ...
                ['key' => 'main_text_1',      'label' => 'Hovedtekst: afsnit 1',                'type' => 'textarea'],
                ['key' => 'main_text_2',      'label' => 'Hovedtekst: afsnit 2',                'type' => 'textarea'],
                ['key' => 'main_text_3',      'label' => 'Hovedtekst: afsnit 3',                'type' => 'textarea'],
                ['key' => 'main_text_4',      'label' => 'Hovedtekst: afsnit 4',                'type' => 'textarea'],
                ['key' => 'therapy_heading',  'label' => 'Overskrift: Hvad er KST?',            'type' => 'text'],
                ['key' => 'therapy_text_1',   'label' => 'Hvad er KST: afsnit 1',               'type' => 'textarea'],
                ['key' => 'therapy_text_2',   'label' => 'Hvad er KST: afsnit 2',               'type' => 'textarea'],
                ['key' => 'therapy_text_3',   'label' => 'Hvad er KST: afsnit 3',               'type' => 'textarea'],
                ['key' => 'therapy_text_4',   'label' => 'Hvad er KST: afsnit 4',               'type' => 'textarea'],
